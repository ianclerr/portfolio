...
const terminalLines = [
    ...
    { text: '<span class="terminal-output">Laravel    Tailwind    PHP    JavaScript    Python</span>', delay: 600 },
    { text: '<span class="terminal-output">PostgreSQL    Blade    Docker    Git    Cloud</span>', delay: 800 },
